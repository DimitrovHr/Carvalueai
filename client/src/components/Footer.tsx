      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/" className="text-black hover:text-primary font-medium text-base">{t.privacyPolicy}</Link></li>
              <li><Link href="/" className="text-black hover:text-primary font-medium text-base">{t.termsOfService}</Link></li>
              <li><Link href="/" className="text-black hover:text-primary font-medium text-base">{t.cookiePolicy}</Link></li>
              <li><Link href="/" className="text-black hover:text-primary font-medium text-base">GDPR</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-lg font-bold text-black tracking-wider uppercase mb-4">
