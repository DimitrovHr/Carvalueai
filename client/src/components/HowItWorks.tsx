          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-neutral-dark">{t.home.howItWorksStep1}</p>
              </dt>
            ...
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-neutral-dark">{t.home.howItWorksStep2}</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-neutral-dark">
                Select between our Regular (€15.99), Premium (€29.99), or Business (€49.99) plan based on your needs.
              </dd>
            </div>
            ...
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-neutral-dark">{t.home.howItWorksStep4}</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-neutral-dark">
